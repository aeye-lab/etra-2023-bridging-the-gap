"""This module contains the implementation of the Localized Attribution Aggregate metric."""
...
class LocalizedAttributionAggregate(Metric):
    """
    ...
    def __init__(
        self,
        aggregation_func: Optional[Callable[[np.ndarray], np.ndarray]] = None,
        abs: bool = False,
        normalise: bool = True,
    ...
    def evaluate_instance(
        ...
        # Select attributions in segmentation map.
        a_s = a[s]

        # Aggregate attributions in segmentation map.
        result = self.aggregation_func(a_s)
